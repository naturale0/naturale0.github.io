...
- [(1) 선형 분류기](/machine%20learning/neural-net-1-linear)
- [(2) 퍼셉트론과 신경망](/machine%20learning/neural-net-2-perceptron-neuralnet)
- [(3) 학습과정 - 개요](/machine%20learning/neural-net-3-training-intro)
- [(4) 학습과정 - 디테일](/machine%20learning/neural-net-4-training-detail)
