...
An algebra can be generated using semi-algebra. $\overline{\mathcal{S}} := \{\text{finite disjoint unions of sets in }\mathcal{S}\}$ is an **algebra generated by a semi-algebra $\mathcal{S}$**. Sometimes we call $\mathcal{S}$ a generator of $\overline{\mathcal{S}}$. Like Borel $\sigma$-field, it is the smallest algebra that contains $\mathcal{S}$.
