---
layout: post
title: "2.S1. Convergence concepts"
date:   2020-12-21 21:46:00 +0900
author: "Sihyung Park"
...
[I already mentioned the proof of it](/2020/12/20/PTE-2.2-Weak-laws-of-large-numbers): Use Markov-Chebyshev inequality.
...
<img src="https://naturale0.github.io/assets/fig/201221_convergence.png" alt="convergence.png" width="250"/>
<br>
...
\end{cases}$
<br>
Then $X_n \overset{P}{\to} 0$ but not in $L^p$ nor $a.s.$ In fact, it does not $L^p$-converge to a constant at all if $p > 1.$
</div>
