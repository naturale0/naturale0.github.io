...
While computing complexities of classes of functions by its cardinality is natural, it reports complexities of every infinite dimensional classes to be the same. We need tools that can differentiate complexities more meticulously. Such tools are entropies of various kinds.
