...
<div style="text-align:center">
<img src="https://naturale0.github.io/assets/fig/201219_step-function.png" alt="riemann-vs-lebesgue.png" width="300"/>
<br>
...
Since it is not difficult to show, I will leave it as an exercise. To prove somewhat straightforward-looking property $\int_E f+g d\mu = \int_E f d\mu + \int_E g d\mu$, we need help of [monotone convergence theorem](https://naturale0.github.io/probability/PTE-1.5-Convergence-theorems-and-inequalities#monotone-convergence-theorem-mct), which will be covered soon.<br><br>
