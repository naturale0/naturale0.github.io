...
My transition into statistics grew out of early experiences in ecology, including work at the Biodiversity and Ecology Lab and assessing endangered Grylloblattidae (icebugs or rock-crawlers) species for the IUCN Red List. Through this work, I recognized both the rapid shift in modern biology toward high-throughput molecular data and the central role that mathematical and statistical frameworks play in describing biological phenomena. Seeking a deeper understanding of molecular data, I studied transcriptome-scale RNA interference at the [Molecular and Computational Genomics Lab](https://clip.mystrikingly.com/). Driven by a desire for rigorous theoretical statistics and a focus on causal mechanisms, I transitioned into graduate training in statistics, specifically high-dimensional methods and causal inference.

My research focuses on causal inference, specifically addressing unmeasured confounding and principal stratification in observational studies, as well as sparse regression. Grounded in my early background in genomics, I am interested in bringing methodological insights to problems unique in modern multi-omics.
